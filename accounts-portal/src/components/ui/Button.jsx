...
export function Button({
  ...
  const variants = {
    primary: 'bg-daemon-green hover:bg-daemon-green-hover text-white shadow-sm',
    purple: 'bg-linear-purple hover:bg-linear-purple-hover text-white',
    ghost: 'bg-transparent hover:bg-white/5 text-linear-text',
    outline: 'bg-transparent border border-white/[0.12] hover:border-white/20 text-linear-text',
