...
| `/setup/ownership` | `OwnershipPage` | 2-step bot START + channel join + ownership transfer |
| `/setup/worker` | `SetupWorker` | Cloudflare API token input → deploy personal worker |
