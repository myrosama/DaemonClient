...
export const SHIM_VERSION = "71659b7abc33";
...
var EncryptionUnavailableError = class extends Error {
  constructor(where) {
    super(
      \`Encryption is enabled for this install but its key material is missing (\${where}). Refusing rather than storing your file unencrypted. Run \\\`daemonclient doctor\\\` to generate the missing keys.\`
    );
...
var WORKER_VERSION = "71659b7abc33";
