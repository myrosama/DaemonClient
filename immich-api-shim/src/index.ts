...
export interface Env {
  ...
  // '1' switches the worker to standalone operation: accounts live in this
  // worker's own D1, no Firebase and no operator deployment service are
  // contacted, and updates are checked against public GitHub releases.
  SELF_HOST?: string;
