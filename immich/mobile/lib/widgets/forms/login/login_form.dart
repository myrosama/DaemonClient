  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(() {
      ...
      if (serverUrl != null) {
        ...
        // DaemonClient users never type a server URL: the central worker is
        // baked in and per-user worker discovery happens after login. The
        // field stays editable for self-hosters/testing.
        serverEndpointController.text = 'https://api.daemonclient.uz';
      }
      return null;
    }, []);
