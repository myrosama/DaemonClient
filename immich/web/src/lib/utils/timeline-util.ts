...
export const toTimelineAsset = (unknownAsset: AssetResponseDto | TimelineAsset): TimelineAsset => {
  ...
  return {
    ...
    telegramFileId: (assetResponse as any).telegramFileId,
    telegramOriginalId: (assetResponse as any).telegramOriginalId,
    telegramThumbId: (assetResponse as any).telegramThumbId,
    telegramChunks: (assetResponse as any).telegramChunks,
    encryptionMode: (assetResponse as any).encryptionMode,
  };
};
