<script lang="ts">
  ...
  import {CommandPaletteProvider, CORE_PAGE_COMMANDS, defaultProvider, MOBILE_APP_COMMANDS, modalManager, OTHER_SITE_COMMANDS, PROJECT_SUPPORT_COMMANDS, ScreencastOverlay, setLocale, setTranslations, SOCIAL_COMMANDS, Theme, themeManager, toastManager, TooltipProvider} from '@immich/ui';
...
<svelte:head>
  <title>{page.data.meta?.title || 'Web'} - DaemonClient Photos</title>
